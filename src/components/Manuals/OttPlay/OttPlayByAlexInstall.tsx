...
function OttPlayByAlexInstall({step}: PropsStep): JSX.Element {
  const {t}: ITranslate = useTranslation();

  return (
    <Card component='div' sx={sxCardMain}>
      <Box component='h4' sx={sxHeadMain}>{t('step')}{step}{t('step-ottplaybyalexInstall')}</Box>
      <CardContent sx={sxManualText1}>{t('televizo_manual2-1')}</CardContent>
      <ImageManual image='OttPlay/ottplaybyalex_manual1.jpg'/>
      ...
      <ImageManual image='OttPlay/ottplaybyalex_manual3.jpg'/>
