...
function SsIptvSamsungInstall({step}: Props) {
  const {t} = useTranslation();
  const linkSsiptvTizen = 'https://ss-iptv.com/files/ssiptv_tizen_usb.zip';
  const linkSsiptvOrsay = 'https://ss-iptv.com/files/ssiptv_orsay_usb.zip';
  ...
  return (
    ...
    >
      <Box component='h4' sx={sxHeadMain}>
        {t('step')}{step}{t('step-ssIptvSamsungInstall')}
      </Box>
