...
function DomaVipRegistration({step}: PropsStep): JSX.Element {
  ...
  return (
    <Card component='div' sx={sxCardMain}>
      ...
      <CardContent sx={sxManualText1}>{t('domavip_manual1-1')}
      </CardContent>
      ...
      <ImageManual image='DomaVip/domavip_01.jpg'/>
      <ImageManual image='DomaVip/domavip_02.jpg'/>
      <CardContent sx={sxManualText1}>{t('domavip_manual1-3')}</CardContent>
      <CardContent sx={sxManualText1}>{t('ilooktv_manual1-4')}</CardContent>
      <ImageManual image='DomaVip/domavip_03.jpg'/>
    </Card>
  );
}

export default DomaVipRegistration;