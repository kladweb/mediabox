...
function HdvideoboxInstall({step}: PropsStep): JSX.Element {
  ...
  return (
    <Card component='div' sx={sxCardMain}>
      ...
      <ImageManual image='AndroidHelp/androidtvbox_manual8_hdvideobox_2.jpg'/>
      ...
      <ImageManual image='Hdvideobox/hdvid_manual_01.jpg'/>
      <ImageManual image='Hdvideobox/hdvid_manual_02.jpg'/>
      <CardContent sx={sxManualText1}>{t('hdvideobox_manual2-5')}</CardContent>
      <ImageManual image='Hdvideobox/hdvid_manual_03.jpg'/>
      <CardContent sx={sxManualText1}>{t('hdvideobox_manual2-6')}</CardContent>
      <ImageManual image='Hdvideobox/hdvid_manual_04.jpg'/>
      <CardContent sx={sxManualText1}>{t('hdvideobox_manual2-7')}</CardContent>
      <ImageManual image='Hdvideobox/hdvid_manual_05.jpg'/>
      ...
      <ImageManual image='Hdvideobox/hdvid_manual_06.jpg'/>
      <CardContent sx={sxManualText1}>{t('hdvideobox_manual2-10')}</CardContent>
      <ImageManual image='Hdvideobox/hdvid_manual_07.jpg'/>
      <ImageManual image='Hdvideobox/hdvid_manual_08.jpg'/>
      <ImageManual image='Hdvideobox/hdvid_manual_09.jpg'/>
